...
const NVXHome = {
        ...
        quiz() {
                ...
                if ( submitBtn ) {
                        form.addEventListener( 'submit', ( e ) => {
                                ...
                                // Validate ALL steps have answers before submitting
                                const answers = {};
        ...
        newsletter() {
                ...
                form.addEventListener( 'submit', ( e ) => {
                        ...
                        if ( ! btn || typeof nvxData === 'undefined' || ! nvxData.ajaxUrl ) {
                        ...
                        formData.append( 'action', 'nvx_newsletter_subscribe' );
                        ...
                        .then( r => r.json() )
                        .then( data => {
                                const msg = ( data.success && data.data && data.data.message )
                                        ? data.data.message
                                        : 'Inscription réussie ! Vérifiez votre email.';

                                btn.innerHTML = '<span class="nvx-btn-animated__text">\u2713 ' + msg + '</span>';
                                btn.style.opacity = '1';
